...
module "org_resources" {
  ...
  dashboard_report_frequency                = var.dashboard_report_frequency
  email_summary_frequency                   = var.email_summary_frequency
  alert_sender                              = var.alert_sender
  alert_recipients                          = var.alert_recipients
  secgroup_automation_principal_exceptions  = var.secgroup_automation_principal_exceptions
  secgroup_automation_monitored_ports       = var.secgroup_automation_monitored_ports
