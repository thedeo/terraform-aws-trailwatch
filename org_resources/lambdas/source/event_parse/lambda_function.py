...
def send_email(event, parsed_event, subject, header, message):
	...
	<tr><td style="background-color: #808080; color: black; border: 1px solid #c4c4c4; width: 100px; font-weight: bold;">KnownIP</td>   <td style="color: black; background-color: #fff;">""" 	  + parsed_event['known_ip']['S'] 	     + """</td></tr>
